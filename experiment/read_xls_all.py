...
neg_sum = 0
del_sum = 0
f_neg = open('./data/neg.csv', 'w', encoding='utf-8')
f_neu = open('./data/neu.csv', 'w', encoding='utf-8')
f_pos = open('./data/pos.csv', 'w', encoding='utf-8')
f_del = open('./data/del.csv', 'w', encoding='utf-8')
...
f_neg.close()
f_del.close()
print("综合累计语料",sum)#6947//6786
print("累计pos/neu/neg/del语料",pos_sum,neu_sum,neg_sum,del_sum)#1422/3972/1374/179
